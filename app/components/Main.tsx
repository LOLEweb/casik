    ...
    <div className='flex justify-between main__block h-screen overflow-hidden'>
      ...
      <div>
        ...
        <div className={`px-2 py-2`}>
          <button
            className='bg-[#353333] rounded-md w-full duration-150 focus:outline-none focus:ring focus:ring-[#fff]'
            onClick={()=> toast('Вы успешло сделали ставку 2x')}>
      ...
      <div>
        <div className={`px-2 py-2`}>
          <button
            className='bg-[#353333] rounded-md w-full duration-150 focus:outline-none focus:ring focus:ring-[#c51951]'
            onClick={()=> toast('Вы успешло сделали ставку 3x')}>
            <div className='px-[10px] py-5'>
      ...
      <div>
        <div className={`px-2 py-2`}>
          <button
            className='bg-[#353333] rounded-md w-full duration-150 focus:outline-none focus:ring focus:ring-[#3bcc92]'
            onClick={()=> toast('Вы успешло сделали ставку 5x')}>
            <div className='px-[10px] py-5'>
      ...
      <div>
        <div className={`px-2 py-2`}>
          <button
            className='bg-[#353333] rounded-md w-full duration-150 focus:outline-none focus:ring focus:ring-[#f39b3b]'
            onClick={()=> toast('Вы успешло сделали ставку 10x')}>
            <div className='px-[10px] py-5'>
